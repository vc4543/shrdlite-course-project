...
var grammar = {
    ...
    {"name": "form$string$3", "symbols": [{"literal":"c"}, {"literal":"a"}, {"literal":"j"}, {"literal":"a"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "form", "symbols": ["form$string$3"], "postprocess": R("box")},
    {"name": "form$subexpression$5$string$1", "symbols": [{"literal":"p"}, {"literal":"i"}, {"literal":"s"}, {"literal":"o"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "form$subexpression$5", "symbols": ["form$subexpression$5$string$1"]},
    {"name": "form$subexpression$5$string$2", "symbols": [{"literal":"s"}, {"literal":"u"}, {"literal":"e"}, {"literal":"l"}, {"literal":"o"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "form$subexpression$5", "symbols": ["form$subexpression$5$string$2"]},
    {"name": "form", "symbols": ["form$subexpression$5"], "postprocess": R("floor")},
